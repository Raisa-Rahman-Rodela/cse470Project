...
<html lang="en">
  ...
  <body> 
	...
	<section id = "section1">
		...
		<div class="title"> Unethical activities are not allowed </div>
        <div class="title"> Only Current University students can access </div>
        <div class="title"> Contents should be copyright free </div>
